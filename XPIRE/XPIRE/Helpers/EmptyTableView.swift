...
public extension UITableView {
    ...
    func setEmptyView(title: String, message: String, titleColor: UIColor, msgColor: UIColor, messageImage: UIImage) {
        ...
        messageImageView.accessibilityLabel = "Animated Arrow"
        messageImageView.isAccessibilityElement = true
        messageImageView.accessibilityTraits = .none
    ...
    func setEmptyView(title: String, message: String, titleColor: UIColor, msgColor: UIColor, bottomConstant: CGFloat) {
        let emptyView = UIView(frame: CGRect(x: self.center.x, y: self.center.y, width: self.bounds.size.width, height: self.bounds.size.height))
        ...
        NSLayoutConstraint.activate([
            ...
            messageLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: bottomConstant),
            messageLabel.leftAnchor.constraint(equalTo: emptyView.leftAnchor, constant: 20),
            messageLabel.rightAnchor.constraint(equalTo: emptyView.rightAnchor, constant: -20)
        ])
